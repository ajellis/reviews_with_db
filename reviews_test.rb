...
class ReviewsTest < Minitest::Test
  ...
  def test_create_new_employee
    assert Employee.create( name: "Joanna", email: "jdark@example.com", number: "515-888-4821", salary: 85000)
    assert_raises(ArgumentError) do
  ...
  def test_add_employee_to_department
    e = Employee.create(name: "Joanna", email: "jdark@example.com", number: "515-888-4821", salary: 85000)
    d = Department.create(name: "Development")
    d.add_employee(e)
    assert d.employees.all.include?(e)
  end

  def test_get_employee_name
    employee = Employee.create( name: "Joanna", email: "jdark@example.com", number: "515-888-4821", salary: 85000)
  ...
  def test_get_department_salary
    employee = Employee.create(name: "Joanna", email: "jdark@example.com", number: "515-888-4821", salary: 80000)
    employee2 = Employee.create(name: "Lunk", email: "lunk@example.com", number: "882-329-3843", salary: 150000)
  ...
  def test_whole_departments_can_get_raises
    employee = Employee.create( name: "Joanna", email: "jdark@example.com", number: "515-888-4821", salary: 80000)
    employee2 = Employee.create( name: "Lunk", email: "lunk@example.com", number: "882-329-3843", salary: 150000)
    employee3 = Employee.create( name: "Sanic", email: "sanic@example.com", number: "333-444-5555", salary: 20000)
    development = Department.create(name: "Development")
    development.add_employee(employee)
    development.add_employee(employee2)
  ...
  def test_total_department_employees
    skip
    joanna = Employee.create(name: "Joanna", email: "jdark@example.com", number: "515-888-4821", salary: 85000)
    development = Department.create(name: "Development")
    development.add_employee(joanna)

    ashley = Employee.create(name: "ashley", email: "acool@example.com", number: "919-888-4821", salary: 85000)
    development.add_employee(ashley)

    andrew = Employee.create(name: "andrew", email: "alame@example.com", number: "919-123-4821", salary: 85000)
    development.add_employee(andrew)

    cheryl = Employee.create(name: "Cheryl", email: "acool@example.com", number: "919-888-4821", salary: 85000)
    engineering = Department.create("Engineering")
    engineering.add_employee(cheryl)

    assert development.employees.include?(joanna)
    assert development.employees.include?(ashley)
    assert development.employees.include?(andrew)
    assert engineering.employees.include?(cheryl)
  end
